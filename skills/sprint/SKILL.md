...
2. **Есть цели в очереди** — очередь целей не пуста.
   Если очередь пуста — сообщи и предложи сформулировать новую цель (перейди к Шагу 2, вариант В).
...
**Жди "ОК" от владельца.** После подтверждения — переходи к фазе 2 (Разработка).
